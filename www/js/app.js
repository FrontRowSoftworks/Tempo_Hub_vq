...
app.config(function($stateProvider, $urlRouterProvider) {
        ...
        $stateProvider
            ...
            .state('ForgotInfo', {
                url: '/ForgotInfo.html',
                templateUrl: 'views/forgotInfo.html'
            })
			.state('createAccount', {
...
$stateProvider
    ...
    /*
$stateProvider.state('forgotInfo', {
  url: '/forgotInfo',
  views: {
    forgotInfo: {
      templateUrl: 'forgotInfo-template.html'
    }
  }
})
})*/
...
app.controller('Controller', ['$scope', '$ionicPopup', '$state', function($scope, $location, $state, $ionicPopup, $timeout){
    ...
    $scope.controller ={};
    $scope.controller.forgotInfo = function() {
...
app.controller('SecurityQuestionCtrl',['$scope', function($scope){
	...
	$scope.question = "What was the name of your first dog?";
}]);
app.controller('EditDetailsCtrl', ['$scope', function ($scope){
	$scope.editDetailsCtrl = {};
	
	$scope.countries = [ {name: "United States"}, {name: "Israel"}, {name: "Afghanistan"}, {name: "Albania"}, {name: "Algeria"},
...
app.controller('CreateAccountCtrl', ['$scope', function($scope){
	...
	$scope.createAccountCtrl = {};
	$scope.createAccountCtrl.createAccount = function(){
		if($scope.password == $scope.confirmPassword && $scope.email != undefined && $scope.phoneNumber != undefined && $scope){
			console.log("hi!");
		};
	};
	$scope.countries = [ {
